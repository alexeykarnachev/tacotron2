...
class WiktionaryAccentor:
    ...
    def _get_accent_online(self, word):
    ...
    def parse_data(self, data: List[str], n_processes=4):
    ...
    @staticmethod
    def get_from_wiki(word, max_n_tries=2):
